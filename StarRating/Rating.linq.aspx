<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rating.linq.aspx.cs" Inherits="StarRating.RatingLinq" %>

<%@ Register Src="~/Controls/StarRating.linq.ascx" TagPrefix="uc1" TagName="StarRating" %>
...
<head runat="server">
    ...
    <style> 
        ...
        img { max-width:100% }
        .container { background-color: #f1f1f1; border: solid 1px #ddd; box-shadow: #ccc 0 0 7px }
    </style>
</head>
<body>
